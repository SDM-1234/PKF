/// <summary>
/// Report Check Printing Report w/o PA (ID 50078).
/// </summary>
report 50078 "Check Printing Report w/o PA"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/ReportsLayout/CheckPrintingReportwoPA.rdl';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Check Printing Report w/o PA';
    dataset
    {
        dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
        {
            ...
            dataitem(VendorDetail_1; "Detailed Vendor Ledg. Entry")
            {
                ...
                begin
                    ...
                    //VendInfo[8] := GetVendor."Service Tax Registration No.";
            ...
            {
                DataItemLink = "Vendor Ledger Entry No." = FIELD("Entry No.");
                DataItemTableView = SORTING("Entry No.") WHERE("Entry Type" = FILTER(Application), "Document Type" = FILTER(Invoice));
            ...
            begin
                ...
                IF BankAccLedgEntry.FINDFIRST THEN BEGIN
                    ...
                    CheckDateFormat := FORMAT(BankAccLedgEntry."Cheque Date", 0, '<Day,2><Month,2><Year4>');
    ...
    var
        ...
        TempCashFlowBuffer: Record "Temp Buffer" temporary;
        Counter: Integer;
