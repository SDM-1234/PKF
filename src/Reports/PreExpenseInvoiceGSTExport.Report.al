report 50015 "Pre Expense Invoice GST Export"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PreExpenseInvoiceGSTExport.rdlc';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(BilltoCustomerState; "Bill to Customer State")
            {
            }
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    GrandTotal += "Sales Line"."Amount To Customer";
                    ReportCheck.InitTextVariable;
                    ReportCheck.FormatNoText(AmountInWords, ROUND(GrandTotal, 1), "Sales Header"."Currency Code");

                    IF "Sales Header"."Currency Code" <> '' THEN BEGIN
                        IF RecCurrency.GET("Sales Header"."Currency Code") THEN
                            intPosition := STRPOS(AmountInWords[1], RecCurrency."Currency Numeric Description")
                    END
                    ELSE BEGIN
                        intPosition := STRPOS(AmountInWords[1], 'RUPEES')
                    END;

                    AmountInWords[1] := COPYSTR(AmountInWords[1], 1, intPosition - 1);
                    AmountInWords[1] := COPYSTR(AmountInWords[1], 6, (STRLEN(AmountInWords[1])));

                    IF "Sales Header"."Sales Currency" = "Sales Header"."Sales Currency"::USD THEN
                        AmountInWords[1] := 'US DOLLARS ' + AmountInWords[1] + ' ONLY'
                    ELSE
                        IF "Sales Header"."Sales Currency" = "Sales Header"."Sales Currency"::EURO THEN
                            AmountInWords[1] := 'EURO ' + AmountInWords[1] + ' ONLY'
                        ELSE
                            IF "Sales Header"."Sales Currency" = "Sales Header"."Sales Currency"::GBP THEN
                                AmountInWords[1] := 'GBP ' + AmountInWords[1] + ' ONLY'
                            ELSE
                                IF "Sales Header"."Sales Currency" = "Sales Header"."Sales Currency"::AED THEN
                                    AmountInWords[1] := 'AED ' + AmountInWords[1] + ' ONLY'
                                ELSE
                                    IF "Sales Header"."Sales Currency" = "Sales Header"."Sales Currency"::BDT THEN
                                        AmountInWords[1] := 'BANGLADESHI TAKA ' + AmountInWords[1] + ' ONLY'
                                    ELSE
                                        IF "Sales Header"."Sales Currency" = "Sales Header"."Sales Currency"::AUD THEN
                                            AmountInWords[1] := 'AUD ' + AmountInWords[1] + ' ONLY'
                                        ELSE
                                            IF "Sales Header"."Sales Currency" = "Sales Header"."Sales Currency"::SGD THEN
                                                AmountInWords[1] := 'SINGAPORE DOLLARS ' + AmountInWords[1] + ' ONLY';
            ...
            begin
                ...
                IF "Sales Header"."Sales Currency" = "Sales Header"."Sales Currency"::" " THEN
                    CurrencyCode := FORMAT("Sales Header"."Sales Currency"::INR)
                ELSE
                    CurrencyCode := FORMAT("Sales Header"."Sales Currency");
                ...
                IF StateL.GET("Bill to Customer State") THEN
    ...
    begin
        ...
        IF CompanyInformation.Name = 'PKF PROSERV PVT. LTD.' THEN BEGIN
            ...
            END ELSE
                ...
                END;
            //RSF.ZOHO-1471[-]
            IF "Sales Header"."Bank Selection For Report" = "Sales Header"."Bank Selection For Report"::ICICI2 THEN BEGIN
                VarText[10] := 'Bank Details:';
                VarText[1] := 'Bank Account No. 003605001058';
                VarText[2] := 'A/c Name: PKF PROSERV PRIVATE LIMITED';
                VarText[3] := 'Bank: ICICI Bank';
                ...
                VarText[9] := '';
            END ELSE
                IF "Sales Header"."Bank Selection For Report" = "Sales Header"."Bank Selection For Report"::ICICI THEN BEGIN
                    VarText[10] := 'Bank Details:';
                    VarText[1] := 'Bank Account No. 000105006757';
                    VarText[2] := 'A/c Name: PKF PROSERV PRIVATE LIMITED';
                    VarText[3] := 'Bank: ICICI Bank';
                    ...
                    VarText[9] := '';
                END ELSE
                    IF "Sales Header"."Bank Selection For Report" = "Sales Header"."Bank Selection For Report"::INDIAN THEN BEGIN
                        VarText[10] := 'Bank Details:';
                        ...
                        VarText[9] := '';
                    END ELSE
                        IF "Sales Header"."Bank Selection For Report" = "Sales Header"."Bank Selection For Report"::HDFC THEN BEGIN
                            VarText[10] := 'Bank Details:';
                            ...
                            VarText[9] := '';
                        END ELSE
                            IF "Sales Header"."Bank Selection For Report" = "Sales Header"."Bank Selection For Report"::HDFC2 THEN BEGIN
                                VarText[10] := 'Bank Details:';
