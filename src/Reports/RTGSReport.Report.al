report 50020 "RTGS Report"
{
    ...
    dataset
    {
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            RequestFilterFields = "Journal Template Name", "Document No.", "Journal Batch Name";
            ...
            column(DocumentNo_GenJnlLine; "Gen. Journal Line"."Document No.")
            {
            }
            ...
            begin
                Cheque := TRUE;
                IF DocumentNo <> "Gen. Journal Line"."Document No." THEN BEGIN
                    ...
                    IF RecGenJounLine.FindSet() THEN
                        REPEAT
                            CLEAR(StoreApplicantAccNo);
                            // Calculating amount [-]
                            IF GLAcc.GET(RecGenJounLine."Account No.") THEN
                            ...
                            IF RecGenJounLine."Account Type" = RecGenJounLine."Account Type"::"Bank Account" THEN BEGIN
                            ...
                            ChequeDateFormat := FORMAT(RecGenJounLine."Cheque Date", 0, '<Day,2><Month,2><Year4>');
                            ...
                            IF RecBeneficiary.GET(RecGenJounLine."Beneficiary Code") THEN BEGIN
                                ...
                                FOR o := 1 TO BeneficiaryAcNoLength DO
                                ...
                                FOR p := 1 TO BeneficiaryNameLength DO
                                ...
                                FOR q := 1 TO BeneficiaryBankNameLength DO
                                ...
                                FOR r := 1 TO BeneficiaryIFSCLength DO
                                ...
                                FOR s := 1 TO BeneficiaryAddrLenth DO
