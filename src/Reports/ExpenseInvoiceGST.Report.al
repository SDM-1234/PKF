report 50012 "Expense Invoice GST"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ExpenseInvoiceGST.rdlc';
    ...
    begin
        ...
        IF CompanyInformation.Name = 'PKF PROSERV PVT. LTD.' THEN BEGIN
            ...
            END ELSE
                ...
                END;
            //ZOHO.RSF.1471[-]
            IF "Sales Invoice Header"."Bank Selection For Report" = "Sales Invoice Header"."Bank Selection For Report"::ICICI2 THEN BEGIN
                VarText[10] := 'Bank Details:';
                VarText[1] := 'Bank Account No. 003605001058';
                VarText[2] := 'A/c Name: PKF PROSERV PRIVATE LIMITED';
                VarText[3] := 'Bank: ICICI Bank';
                ...
                VarText[9] := '';
            END ELSE
                IF "Sales Invoice Header"."Bank Selection For Report" = "Sales Invoice Header"."Bank Selection For Report"::ICICI THEN BEGIN
                    VarText[10] := 'Bank Details:';
                    VarText[1] := 'Bank Account No. 000105006757';
                    VarText[2] := 'A/c Name: PKF PROSERV PRIVATE LIMITED';
                    VarText[3] := 'Bank: ICICI Bank';
                    ...
                    VarText[9] := '';
                END ELSE
                    IF "Sales Invoice Header"."Bank Selection For Report" = "Sales Invoice Header"."Bank Selection For Report"::INDIAN THEN BEGIN
                        VarText[10] := 'Bank Details:';
                        ...
                        VarText[9] := '';
                    END ELSE
                        IF "Sales Invoice Header"."Bank Selection For Report" = "Sales Invoice Header"."Bank Selection For Report"::HDFC THEN BEGIN
                            VarText[10] := 'Bank Details:';
                            ...
                            VarText[9] := '';
                        END ELSE
                            IF "Sales Invoice Header"."Bank Selection For Report" = "Sales Invoice Header"."Bank Selection For Report"::HDFC2 THEN BEGIN
                                VarText[10] := 'Bank Details:';
